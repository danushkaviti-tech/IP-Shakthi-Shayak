...
function generateStatutoryFallback(prompt) {
  ...
  // Handle casual greetings gracefully
  ...
  if (casualWords.some((w) => lowerQ === w || lowerQ.startsWith(w + " ") || lowerQ.endsWith(" " + w))) {
    if (lang === "Telugu") return "నమస్కారం! నేను IP-SAKTI సహాయక్. మేధో సంపత్తి, పేటెంట్లు, ట్రేడ్‌మార్క్‌లు మరియు పత్రాల విశ్లేషణలో మీకు ఎలా సహాయపడగలను?";
    ...
    return "Hello! I am IP-SAKTI Sahayak, your AI assistant for Intellectual Property, Patent Regulations, Trademarks, Copyrights, and Document Analysis. How can I assist you with your IP filings or legal research today?";
  }
